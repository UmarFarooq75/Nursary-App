...
export default function PlantsComponent({ title }: any): JSX.Element {
  ...
  return (
    <div className="mt-10 border-gray-400">
      <h1 className="text-2xl mb-10 ml-9 font-semibold">{title}</h1>
