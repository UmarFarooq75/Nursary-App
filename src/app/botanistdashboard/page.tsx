    ...
    <>
      ...
      <div className="flex flex-col bg-white p-4 lg:p-8 xl:w-full">
        <div className="text-center mb-8">
          <h1 className="text-2xl lg:text-3xl xl:text-4xl text-opacity-75 font-semibold">
            DashBoard
          </h1>
        </div>
        ...
        <div className="max-w-full lg:w-[95%] mx-auto mt-8 lg:mt-10">
          ...
          <div className="grid grid-cols-5 text-center font-semibold px-2 py-3 bg-gray-200 rounded-tl-lg rounded-tr-lg">
            ...
            <span className="col-span-5 lg:col-span-1">Cust ID</span>
            <span className="col-span-5 lg:col-span-1">Phone</span>
            <span className="col-span-5 lg:col-span-1">Request Date</span>
