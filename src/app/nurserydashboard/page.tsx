    ...
    <>
      ...
      <div className="flex flex-col bg-white p-4 lg:p-8 xl:w-full">
        ...
        <div className="flex flex-row justify-between lg:mt-8">
          <h1 className="ml-8 text-gray-700 text-lg font-semibold lg:text-md xl:text-lg text-opacity-75 ">
            Mali List
          </h1>
          <Link
            href="addmali"
            className="flex items-center justify-end bg-blue-600 px-6 h-[33px] shadow-lg  rounded-md"
          >
            <span className="text-white text-sm">Add Mali</span>
          </Link>
        </div>
        <div className="flex lg:flex-row lg:ml-10 lg:w-[90%] space-y-4 lg:space-y-0 lg:space-x-4  mt-8">
          <div className="p-3 lg:p-4 bg-green-400 lg:w-[30%] space-y-4 lg:space-y-7">
            <div className="flex flex-row justify-between items-center">
              <span className="text-gray-600">Total Mali</span>
              <button>
                <HiOutlineDotsVertical />
              </button>
            </div>
          ...
          <div className="p-3 lg:p-4 bg-purple-400  lg:w-[30%] space-y-4 lg:space-y-7">
            <div className="flex flex-row justify-between items-center">
              <span className="text-gray-600">On Work</span>
              <button>
                <HiOutlineDotsVertical />
              </button>
            </div>
          ...
          <div className="p-3 lg:p-4 bg-red-400 lg:w-[30%] space-y-4 lg:space-y-7">
            <div className="flex flex-row justify-between items-center">
              <span className="text-gray-600">Off Work</span>
              <button>
                <HiOutlineDotsVertical />
              </button>
            </div>
        ...
        <div className="max-w-full lg:w-[95%] mx-auto mt-8 lg:mt-10">
          ...
          <div className="grid grid-cols-5 text-center font-semibold px-2 py-3 bg-gray-200 rounded-tl-lg rounded-tr-lg">
            <span className="col-span-5 lg:col-span-1">Name</span>
            <span className="col-span-5 lg:col-span-1">Mali ID</span>
            <span className="col-span-5 lg:col-span-1">Number</span>
            <span className="col-span-5 lg:col-span-1">Total Deliveries</span>
            <span className="col-span-5 lg:col-span-1">Status</span>
          </div>
        ...
        <h1 className="ml-10 mt-8 text-gray-700 text-lg font-semibold lg:text-md xl:text-lg text-opacity-75 lg:mt-12">
          Order List
        </h1>
